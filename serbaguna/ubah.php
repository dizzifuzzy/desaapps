...
$cekserbaguna = $mysqli->query("SELECT * FROM serba_guna JOIN data_diri ON serba_guna.id_dd = data_diri.id_dd where serba_guna.id_serbaguna=$id");
$ea     = $cekinstansi->fetch_assoc();
$row    = $cekserbaguna->fetch_assoc();
$alamats = $row['alamat_serbaguna']." sip";
...
<head>
        ...
        <title>Serba Guna - <?=$ea['app_instansi'];?></title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        <!-- App Icons -->
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            <h4 class="page-title">Serba Guna</h4>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card m-b-30">
                            <div class="card-body">
                                <h4 class="mt-0 header-title">Ubah Data</h4>
                                    ...
                                    if($_POST['nomorsurat']){
                                        ...
                                        if(($nosurat==NULL)||($tanggalsurat==NULL)||($alamat==NULL)||($desa==NULL)||($kecamatan==NULL))
                                        {
                                            ...
                                            $submit = $mysqli->query("UPDATE serba_guna SET no_surat_serbaguna = '$nosurat', tgl_surat_serbaguna = '$tanggalsurat', pendidikan_serbaguna = '$pendidikan', pekerjaan_serbaguna = '$pekerjaan', perkawinan_serbaguna = '$perkawinan', alamat_serbaguna = '$alamat', desa_serbaguna = '$desa', kecamatan_serbaguna = '$kecamatan' WHERE id_serbaguna = $id;");
                                            $mysqli->query("INSERT INTO aktivitas (kunci_aktivitas, nama_aktivitas,waktu_aktivitas,id_petugas) VALUES ('id: $id - serbaguna','Mengubah data Serba Guna dengan nomor surat $nosurat','$tgl','$idpetugas')");
                                            if($submit){
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input class="form-control" type="text" name="nomorsurat" value="<?=$row['no_surat_serbaguna'];?>">
                                    </div>
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Tanggal Surat</label>
                                    <div class="col-sm-5">
                                        <input class="form-control" type="date" name="tanggalsurat" value="<?=$row['tgl_surat_serbaguna'];?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="autocomplete col-sm-10">
                                        <input class="form-control" type="text" name="pendidikan" id="pendidikan" value="<?=$row['pendidikan_serbaguna'];?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Pekerjaan</label>
                                    <div class="autocomplete col-sm-10">
                                        <input class="form-control" type="text" name="pekerjaan" id="pekerjaan" value="<?=$row['pekerjaan_serbaguna'];?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Status Perkawinan</label>
                                    <div class="autocomplete col-sm-10">
                                        <input class="form-control" type="text" name="perkawinan" id="perkawinan" value="<?=$row['perkawinan_serbaguna'];?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="autocomplete col-sm-10">
                                        <input class="form-control" type="text" name="desa" id="desa" value="<?=$row['desa_serbaguna'];?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Kecamatan</label>
                                    <div class="autocomplete col-sm-10">
                                        <input class="form-control" type="text" name="kecamatan" id="kecamatan" value="<?=$row['kecamatan_serbaguna'];?>">
                                    </div>
                                </div>
