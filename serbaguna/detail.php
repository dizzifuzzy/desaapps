                        ...
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input class="form-control" type="text" name="nomorsurat" value="<?=$row['no_surat_serbaguna'];?>" disabled>
                                    </div>
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Tanggal Surat</label>
                                    <div class="col-sm-5">
                                        <input class="form-control" type="date" name="tanggalsurat" value="<?=$row['tgl_surat_serbaguna'];?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="autocomplete col-sm-10">
                                        <input class="form-control" type="text" name="pendidikan" id="pendidikan" value="<?=$row['pendidikan_serbaguna'];?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Pekerjaan</label>
                                    <div class="autocomplete col-sm-10">
                                        <input class="form-control" type="text" name="pekerjaan" id="pekerjaan" value="<?=$row['pekerjaan_serbaguna'];?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Status Perkawinan</label>
                                    <div class="autocomplete col-sm-10">
                                        <input class="form-control" type="text" name="perkawinan" id="perkawinan" value="<?=$row['perkawinan_serbaguna'];?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="autocomplete col-sm-10">
                                        <input class="form-control" type="text" name="desa" id="desa" value="<?=$row['desa_serbaguna'];?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Kecamatan</label>
                                    <div class="autocomplete col-sm-10">
                                        <input class="form-control" type="text" name="kecamatan" id="kecamatan" value="<?=$row['kecamatan_serbaguna'];?>" disabled>
                                    </div>
                                </div>
