                        ...
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input class="form-control" type="text" name="nomorsurat" value="<?=$row['no_surat_sku'];?>" disabled>
                                    </div>
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Tanggal Surat</label>
                                    <div class="col-sm-5">
                                        <input class="form-control" type="date" name="tanggalsurat" value="<?=$row['tgl_surat_sku'];?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input class="form-control" type="text" name="kp" value="<?=$kp[1];?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Desa</label>
                                    <div class="autocomplete col-sm-10">
                                        <input class="form-control" type="text" name="desa" id="desa" value="<?=$row['desa_sku'];?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Kecamatan</label>
                                    <div class="autocomplete col-sm-10">
                                        <input class="form-control" type="text" name="kecamatan" id="kecamatan" value="<?=$row['kecamatan_sku'];?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Nama Perusahaan</label>
                                    <div class="autocomplete col-sm-10">
                                        <input class="form-control" type="text" name="namaperusahaan" value="<?=$row['nama_perusahaan_sku'];?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Jenis Perusahaan</label>
                                    <div class="autocomplete col-sm-10">
                                        <input class="form-control" type="text" name="jenisperusahaan" value="<?=$row['jenis_perusahaan_sku'];?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Alamat Perusahaan</label>
                                    <div class="autocomplete col-sm-10">
                                        <textarea class="form-control" type="text" name="alamatperusahaan" disabled><?=$row['alamat_perusahaan_sku'];?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Keterangan Perusahaan</label>
                                    <div class="autocomplete col-sm-10">
                                        <textarea class="form-control" type="text" name="keteranganperusahaan" disabled><?=$row['keterangan_sku'];?></textarea>
                                    </div>
                                </div>
